...
<!--<![endif]-->
    <div class="wrapper" style="background-color: #eaf7fc;">
      ...
      <p style="Margin-top: 0;Margin-bottom: 20px;">&#20146;&#29233;&#30340;&#28216;&#23458;,</p>
    </div>
      ...
      <div style="line-height:20px;font-size:1px">&nbsp;</div>
            ...
            <div style="Margin-left: 20px;Margin-right: 20px;">
      <h1 style="Margin-top: 0;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #345e9e;font-size: 26px;line-height: 34px;font-family: Bitter,Georgia,serif;text-align: center;">恭喜你</h1><h1 style="Margin-top: 20px;Margin-bottom: 0;font-style: normal;font-weight: normal;color: #345e9e;font-size: 26px;line-height: 34px;font-family: Bitter,Georgia,serif;text-align: center;">您所提交的 <?php if($type == 'oc'){ echo "线上游戏";}else if($type == 'ld'){ echo "分享彩金";}else if($type == 'bl'){ echo "黑庄娱乐城";}?></h1><h1 style="Margin-top: 20px;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #345e9e;font-size: 26px;line-height: 34px;font-family: Bitter,Georgia,serif;text-align: center;">已被审核通过!</h1>
    </div>
    ...
    <?php if($type == 'oc'){?>
    <div style="Margin-left: 20px;Margin-right: 20px;">
      <p style="Margin-top: 0;Margin-bottom: 0;text-align: left;">提交日期：<?php echo $submit_date;?></p>
<p style="Margin-top: 20px;Margin-bottom: 0;text-align: left;">游戏网址：<?php echo $onlinecasino_url;?></p>
<p style="Margin-top: 20px;Margin-bottom: 0;text-align: left;">游戏说明：<?php echo nl2br($onlinecasino_desc);?></p>
<!--<p style="Margin-top: 20px;Margin-bottom: 0;text-align: left;">批准日期：<?php echo $approved_date;?></p><p style="Margin-top: 20px;Margin-bottom: 20px;text-align: center;">&nbsp;</p>-->
    </div>
    <?php }else if($type == 'ld'){?>
    <div style="Margin-left: 20px;Margin-right: 20px;">
      <p style="Margin-top: 0;Margin-bottom: 0;text-align: left;">提交日期：<?php echo $submit_date;?></p>
      <p style="Margin-top:20px;Margin-bottom: 0;text-align: left;">公司名：<?php echo $luckydraw_name;?></p>
<p style="Margin-top: 20px;Margin-bottom: 0;text-align: left;">公司网址：<?php echo $luckydraw_url;?></p>
<p style="Margin-top: 20px;Margin-bottom: 0;text-align: left;">优惠标题：<?php echo $luckydraw_code;?></p>
<p style="Margin-top: 20px;Margin-bottom: 0;text-align: left;">优惠简介：<?php echo nl2br($luckydraw_desc);?></p>
<!--<p style="Margin-top: 20px;Margin-bottom: 0;text-align: left;">批准日期：<?php echo $approved_date;?></p><p style="Margin-top: 20px;Margin-bottom: 20px;text-align: center;">&nbsp;</p>-->
    </div>    
    <?php }else if($type == 'bl'){?>
    <div style="Margin-left: 20px;Margin-right: 20px;">
      <p style="Margin-top: 0;Margin-bottom: 0;text-align: left;">提交日期：<?php echo $submit_date;?></p>
      <p style="Margin-top:20px;Margin-bottom: 0;text-align: left;">公司名：<?php echo $rblacklist_name;?></p>
<p style="Margin-top: 20px;Margin-bottom: 0;text-align: left;">公司网址：<?php echo $rblacklist_url;?></p>
<p style="Margin-top: 20px;Margin-bottom: 0;text-align: left;">简单说明：<?php echo nl2br($rblacklist_desc);?></p>
<!--<p style="Margin-top: 20px;Margin-bottom: 0;text-align: left;">批准日期：<?php echo $approved_date;?></p><p style="Margin-top: 20px;Margin-bottom: 20px;text-align: center;">&nbsp;</p>-->
    </div>    
    <?php }?>
    <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 120px;">
      <div class="btn btn--flat" style="Margin-bottom: 20px;text-align: center;">
        <a style="border-radius: 4px;display: inline-block;font-weight: bold;text-align: center;text-decoration: none !important;transition: opacity 0.1s ease-in;color: #fff;background-color: #9ec9df;font-family: Roboto, Tahoma, sans-serif;font-size: 14px;line-height: 24px;padding: 12px 35px;" href="<?php echo $url;?>" data-width="200">现在就游览你所提交的线上游戏</a>
      </div>
    </div>
