    ...
    <script src='<?php echo include_webroot;?>/plugins/fullcalendar/moment.min.js'></script>
    <script src='<?php echo include_webroot;?>/plugins/fullcalendar/jquery.min.js'></script>
    <script src='<?php echo include_webroot;?>/plugins/fullcalendar/fullcalendar.min.js'></script>
